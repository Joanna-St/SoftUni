...
CREATE TABLE orders(
    ...
    CONSTRAINT fk_tables_ids
    FOREIGN KEY (table_id)
    REFERENCES `tables`(id),
    CONSTRAINT fk_waiters_ids
...
CREATE TABLE orders_clients(
    order_id INT,
    client_id INT,
    CONSTRAINT fk_orders_ids
    FOREIGN KEY (order_id)
    REFERENCES orders(id),
    CONSTRAINT fk_clients_ids
...
CREATE TABLE orders_products(
    order_id INT,
    product_id INT,
    CONSTRAINT fk_orders_ids_for_products
    FOREIGN KEY (order_id)
    REFERENCES orders(id),
    CONSTRAINT fk_products_ids
